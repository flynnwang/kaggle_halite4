...
AGENTS = [
  ...
  agent("agent_bee_v7_0_0.py", check=True),
  # agent("agent_bee_v4_16_10.py", check=True),

  # agent("agent_bee_v4_16_09.py", check=True),
  # agent("agent_bee_v4_16_08.py", check=True),
  # agent("agent_bee_v4_16_07.py", check=True),

  # agent("agent_bee_v4_16_06.py", check=True),
  # agent("agent_bee_v4_16_05.py", check=True),

  # agent("agent_bee_v4_16_04.py", check=True),
  # agent("agent_bee_v4_16_03.py", check=True),
  # agent("agent_bee_v4_16_02.py", check=True),
  # agent("agent_bee_v4_16_01.py", check=True),

  # agent("agent_bee_v4_15_11.py", check=True),
  # agent("agent_bee_v4_15_12.py", check=True),

  # agent("agent_bee_v4_15_10.py", check=True),
  # agent("agent_bee_v4_15_09.py", check=True),

  # agent("agent_bee_v4_15_08.py", check=True),
  # agent("agent_bee_v4_15_07.py", check=True),
  # agent("agent_bee_v4_15_06.py", check=True),
  # agent("agent_bee_v4_15_05.py", check=True),
  # agent("agent_bee_v4_15_04.py", check=True),
  # agent("agent_bee_v4_15_03.py", check=True),
  # agent("agent_bee_v4_15_02.py", check=True),
  # agent("agent_bee_v4_15_01.py", check=True),

  # agent("agent_bee_v4_14_14.py", check=True),
  # agent("agent_bee_v4_14_13.py", check=True),
  # agent("agent_bee_v4_14_12.py", check=True),
  # agent("agent_bee_v4_14_11.py", check=True),
  # agent("agent_bee_v4_14_10.py", check=True),
  # agent("agent_bee_v4_14_09.py", check=True),
  # agent("agent_bee_v4_14_08.py", check=True),
  ...
  # agent("agent_bee_v4_14_02.py", check=True),
  # agent("agent_bee_v4_14_01.py", check=True),

  # agent("agent_bee_v4_13_11.py", check=True),
  ...
  # agent("agent_bee_v4_13_5.py", check=True),
  # agent("agent_bee_v4_13_4.py", check=True),
  # agent("agent_bee_v4_13_3.py", check=True),
