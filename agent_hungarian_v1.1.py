#!/usr/bin/env python
"""Tests expect_return using first round expect return.

ACCEPT.

Tournament - ID: NZIp09, Name: Your Halite 4 Trueskill Ladder | Dimension - ID: RfiiRz, Name: Halite 4 Dimension
Status: running | Competitors: 7 | Rank System: trueskill

Total Matches: 100 | Matches Queued: 8
Name                           | ID             | Score=(μ - 3σ)  | Mu: μ, Sigma: σ    | Matches
Hungarian v1.1                 | IojmuZLmGBFH   | 27.9658745      | μ=30.895, σ=0.976  | 50
Hungarian v2                   | BU1dBLPQpWkM   | 27.7991520      | μ=30.601, σ=0.934  | 53
Hungarian v1                   | hpzBUIDMXYj1   | 27.4028619      | μ=30.490, σ=1.029  | 43
swarm                          | Qo2zP6sKSChf   | 26.3525539      | μ=29.045, σ=0.897  | 55
Manhattan                      | BpQScu5dcN1w   | 19.7984195      | μ=22.218, σ=0.807  | 77
somebot                        | sH4gVSOXURbh   | 18.2510160      | μ=20.897, σ=0.882  | 64
stillbot                       | vPCmHAOvteuW   | 13.2777104      | μ=16.401, σ=1.041  | 58
"""
